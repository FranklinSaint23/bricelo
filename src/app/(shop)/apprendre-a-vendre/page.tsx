        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-8">
          ...
          <div className="shrink-0">
            <Link
              ...
              className="h-12 px-6 rounded-xl bg-amber-400 hover:bg-amber-500 text-slate-950 font-black text-sm shadow-xl shadow-amber-400/20 transition-transform hover:scale-105 flex items-center justify-center gap-2 btn-animate-attention"
            >
