...
export default function ContactPage() {
  ...
  const contactInfo = [
    { Icon: Mail,  label: fr ? 'E-mail'    : 'Email',   value: 'bricelo237@gmail.com', sub: fr ? 'Réponse sous 24h'           : 'Reply within 24h' },
    { Icon: Phone, label: fr ? 'Téléphone' : 'Phone',   value: '+237 6 52 70 42 18',   sub: fr ? 'Lun–Sam, 8h–20h'            : 'Mon–Sat, 8am–8pm' },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[var(--color-slate-200)] rounded-2xl p-6 shadow-sm">
          ...
          <form className="flex flex-col gap-4" action="mailto:bricelo237@gmail.com" method="get">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[var(--color-navy-900)]">{fr ? 'Nom et Prénom *' : 'Full name *'}</label>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-[var(--color-navy-900)] rounded-2xl p-5 text-white">
            ...
            <a href="https://wa.me/237652704218" target="_blank" rel="noopener noreferrer"
