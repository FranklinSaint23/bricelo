...
export const metadata = { title: 'Contactez-nous — BRICELO' }

export default function ContactPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      <div className="mb-10">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-[var(--color-navy-900)] mb-3">Contactez-nous</h1>
        <p className="text-[var(--color-slate-500)]">Notre équipe est disponible 7j/7 pour vous aider.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-[var(--color-slate-200)] rounded-2xl p-6 shadow-sm">
          ...
          <form className="flex flex-col gap-4" action="mailto:contact@bricelo.com" method="get">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[var(--color-navy-900)]">Nom complet *</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[var(--color-navy-900)]">Adresse e-mail *</label>
              <input type="email" name="email" required placeholder="vous@email.com"
                className="h-10 px-3 text-sm border border-[var(--color-slate-200)] rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] focus:border-transparent" />
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[var(--color-navy-900)]">Sujet</label>
              <select name="subject"
                ...
                <option>Signaler un produit</option>
                <option>Candidature vendeur</option>
                <option>Autre</option>
              </select>
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[var(--color-navy-900)]">Message *</label>
              <textarea name="body" required rows={5} placeholder="Décrivez votre demande..."
        ...
        <div className="flex flex-col gap-5">
          {[
            { Icon: Mail,    label: 'E-mail',    value: 'contact@bricelo.com',   sub: 'Réponse sous 24h' },
            { Icon: Phone,   label: 'Téléphone', value: '+237 6XX XXX XXX',      sub: 'Lun–Sam, 8h–20h' },
            { Icon: MapPin,  label: 'Adresse',   value: 'Douala, Cameroun',      sub: 'Siège social BRICELO' },
            { Icon: Clock,   label: 'Horaires',  value: 'Lun–Dim : 8h – 22h',   sub: 'Service client disponible' },
          ...
          <div className="bg-[var(--color-navy-900)] rounded-2xl p-5 text-white">
            ...
            <p className="text-sm text-white/65 mb-3">Chattez directement avec notre équipe support.</p>
