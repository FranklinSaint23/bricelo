  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 my-8">
      <div className="rounded-2xl bg-[var(--color-navy-900)] p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 shadow-xl border border-white/10 relative overflow-hidden">
        ...
        {/* Boutons d'actions côte à côte avec l'animation btn-animate-attention (comme le bouton Commander maintenant) */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full lg:w-auto relative z-10 shrink-0">
          <Link
            ...
            className="h-12 px-6 rounded-xl bg-amber-400 hover:bg-amber-500 text-slate-950 font-black text-sm shadow-lg shadow-amber-400/30 transition-all hover:scale-105 flex items-center justify-center gap-2 btn-animate-attention"
          >
          ...
          <Link
            ...
            className="h-12 px-6 rounded-xl bg-white/10 hover:bg-white/20 text-white border-2 border-amber-400/50 font-extrabold text-sm transition-all hover:scale-105 flex items-center justify-center gap-2.5 shadow-md group relative overflow-hidden btn-animate-attention"
          >
            <PlayCircle className="h-5 w-5 text-amber-400 group-hover:scale-110 transition-transform" />
